...
void rest(Player& player) {
	...
	system("CLS");
	if (player.money >= 50 && player.health != "Full" || player.money >= 50 && player.energy != 100) { player.energy = 100;player.health = "Full";player.money -= 50;player.l_a = player.r_a = player.l_l = player.r_l = "Normal";infoStream << "You rested and healed.";textBox(infoStream.str());Sleep(1400); }
